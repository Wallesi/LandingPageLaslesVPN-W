...
const Mapa = () => {
    return (
        ...
        <div className="m-10 md:m-20 flex flex-col items-center">
            ...
            <h4 className="dark:text-slate-400 text-lg md:text-xl mt-10 md:mt-10 text-[#4F5665]">See <span className="font-bold">LaslesVPN</span> everywhere to make it easier for you when you</h4>
            <h4 className=" dark:text-slate-400 text-lg md:text-xl text-[#4F5665]">move locations.</h4>
