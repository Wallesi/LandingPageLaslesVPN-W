...
const Features = () => {
    return (
        ...
        <div className="flex flex-col md:flex-row p-4 md:m-10">
            ...
            <div className="w-full md:w-1/2 p-5">
                <h1 className="text-3xl md:text-4xl pt-3 font-medium">We Provide Many Features You Can Use</h1>
                <h2 className="dark:text-slate-300 mt-3 md:mt-5 text-[#4F5665]">You can explore th features that we provide with fun and have their own functions each feature.</h2>
                ...
                <div className="grid gap-3 md:grid-cols-1 mt-4 md:mt-5 text-[#4F5665]">
                    <div className="flex items-center mt-5">
                        ...
                        <p className="ml-2 dark:text-slate-400">Powerfull online protection.</p>
                    </div>
                    ...
                    <div className="flex items-center mt-5">
                        ...
                        <p className="ml-2 dark:text-slate-400">Internet without borders.</p>
                    </div>
                    ...
                    <div className="flex items-center mt-5">
                        ...
                        <p className="ml-2 dark:text-slate-400">Supercharged VPN.</p>
                    </div>
                    ...
                    <div className="flex items-center mt-5">
                        ...
                        <p className="ml-2 dark:text-slate-400">No specific time limits.</p>
                    </div>
                </div>
