...
//     firstName: yup.string().required("First Name is required").max(10, "Max of 10 characters"),
//     lastName: yup.string().required("Last Name is required").max(10, "Max of 10 characters"),
//     email: yup.string().required("Email is required").max(20, "Max of 20 characters"),
//     phone: yup.string().required("phone is required").max(10, "Max of 10 characters"),
//     message: yup.string().required("Message is required").max(10, "Max of 200 characters"),
// }).required();
    ...
    return (
        <div className="flex flex-col pb-10" style={{ background: 'linear-gradient(to top, #F8F8F8 75%, transparent 70%)' }}>
            <div className="container mx-auto max-w-8 footer-fondo" >
                ...
                {/* Formulario */}
                <div className="m-10 bg-white p-10 border rounded-2xl">
                        ...
                        <div className="col-span-2">
                            <div className="flex gap-4 ">
                                <div className="w-1/2">
                                    ...
                                    <input type="text" id="first-name" placeholder="Phil" className="w-full border text-sm rounded-md px-2 py-1" />
                                </div>
                                <div className="w-1/2">
                                    <label htmlFor="last-name">Last Name</label>
                                    <input type="text" id="last-name" placeholder="Collins" className="w-full border text-sm rounded-md px-2 py-1" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2">
                            <div className="flex gap-4 ">
                                <div className="w-1/2">
                                    ...
                                    <input type="text" id="from" placeholder="philcollins@gmail.com" className="w-full text-sm border rounded-md px-2 py-1" />
                                </div>
                                <div className="w-1/2">
                                    <label htmlFor="from">Cell Phone</label>
                                    <input type="text" id="from" placeholder="+54 342 5990801" className="w-full text-sm border rounded-md px-2 py-1" />
                                </div>
                            </div>
                            <div className="mt-4">
                                <label htmlFor="message">Message</label>
                                <textarea id="message" placeholder="Message" className="w-full text-sm border rounded-md px-2 py-1 resize-y min-h-[3rem]" />
                            </div>
                        </div>
                    </div>
                    </form>
                    ...
                    <div className="flex justify-center mt-8">
                        <button className="bg-[#F53838] border w-1/2 pt-3 pb-3 pl-10 pr-10 rounded-xl text-white font-semibold text-sm boton-fondo2">Submit</button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 pl-10 pr-10">
                    <div className="col-span-2  p-4">
                        ...
                        <p className="mt-5 text-[#4F5665] text-base">
                    ...
                    <div className="col-span-1 p-4">
                        ...
                        <ul className="text-base text-[#4F5665] mt-5">
